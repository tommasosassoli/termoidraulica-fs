...
public class ClientInsertController extends AbstractController {
	@FXML
	...
	public ClientInsertController(ViewManager viewManager) {
		super(viewManager);
	}
	...
	private void insert() {
		if (validateInput()) {
			...
			result = ClientsManagement.instance().addClient(name.getText(), surname.getText(),
