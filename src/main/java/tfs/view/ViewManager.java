...
import tfs.modules.estimates.view.controller.MenuBarController;
...
public class ViewManager {
	...
	public ViewManager(Stage stage) {
		primaryStage = stage;
		primaryStage.setTitle(CompanyDataManagement.instance().getCompanyData().getCompanyName());
	}
	...
	public static void launchInfoDialog(String str) {
		...
		alert.setTitle(CompanyDataManagement.instance().getCompanyData().getCompanyName());
